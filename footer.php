            ...
            <div class="modal-footer">
                <p class="text-center" style="font-size: 12px">
                    * Поля, обозначенные звездочкой обязательны для заполнения. Отправьте нам телефон или e-mail, и мы свяжемся с вами в течение часа<br>
                    Нажимая на кнопку "Отправить", я даю свое согласие на обработку персональных данных и соглашаюсь с условиями и <a href="/privacy" target="_blank">политикой конфиденциальности</a>
                </p>
            </div>
        </div>
    </div>
