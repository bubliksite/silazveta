...
<div class="container my-5 py-3">
    <h3 class="mb-3">Политика в отношении обработки персональных данных</h3>
    ...
    безопасности персональных данных, предпринимаемые ООО Спиркс (далее – Оператор).<br>
    ...
    информации, которую Оператор может получить о посетителях веб-сайта <a href="/">https://silazveta.ru</a>.<br>
    <br>
    ...
    обеспечивающих их доступность в сети интернет по сетевому адресу <a href="/">https://silazveta.ru</a>;<br>
    ...
    Пользователю веб-сайта <a href="/">https://silazveta.ru</a>;<br>
    2.9. Пользователь – любой посетитель веб-сайта <a href="/">https://silazveta.ru</a>;<br>
    ...
    направив Оператору письмо на адрес электронной почты <a href="mailto: info@silazveta.ru">info@silazveta.ru</a>
    с пометкой «Отказ от уведомлений о новых продуктах и услугах и специальных предложениях».<br>
    ...
    <a href="/">https://silazveta.ru</a>. Заполняя соответствующие формы и/или отправляя свои
    персональные данные Оператору, Пользователь выражает свое согласие с данной Политикой.<br>
    ...
    <a href="mailto: info@silazveta.ru">info@silazveta.ru</a> с пометкой «Актуализация персональных данных».<br>
    ...
    электронный адрес Оператора <a href="mailto: info@silazveta.ru">info@silazveta.ru</a> с пометкой «Отзыв согласия на
    ...
    данных, обратившись к Оператору с помощью электронной почты <a href="mailto: info@silazveta.ru">info@silazveta.ru</a>.<br>
    ...
    <a href="/privacy">https://silazveta.ru/privacy</a>.<br>
</div>
