...
<div class="container my-5 py-3">
    ...
    информации, которую Оператор может получить о посетителях веб-сайта <a href="/">silazveta.ru</a>.<br>
    <br>
    ...
    обеспечивающих их доступность в сети интернет по сетевому адресу <a href="/">silazveta.ru</a>;<br>
    ...
    Пользователю веб-сайта <a href="/">silazveta.ru</a>;<br>
    2.9. Пользователь – любой посетитель веб-сайта <a href="/">silazveta.ru</a>;<br>
    ...
    <a href="/">silazveta.ru</a>. Заполняя соответствующие формы и/или отправляя свои
    ...
    <a href="/privacy">silazveta.ru/privacy</a>.<br>
</div>
